...
{
    public class Terroist : ModItem  //this is the class name
    {
        ...
        public override void SetDefaults()
        {
            ...
            item.useTime = 5;        //How long it takes to use the item, in frames
            ...
            item.shootSpeed = 20f; //this is the speed of the projectile that is created          

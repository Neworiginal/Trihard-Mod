...
namespace Trihard.Weapon               //We need this to basically indicate the folder where it is to be read from, so you the texture will load correctly
{
    public class Trinamite : ModItem
    {
        public override void SetDefaults()
        {
            item.damage = 0;     //The damage stat for the Weapon.                 
            item.width = 20;    //sprite width
            item.height = 64;   //sprite height
            ...
            item.shoot = mod.ProjectileType("TrinamiteProjectile"); //This defines what type of projectile this item will shoot	
        ...
        public override void AddRecipes()   //This defines the crafting recepe for this item
        {
            ...
            recipe.AddIngredient(ItemID.Dynamite, 5000); //this is how to add an ingredient from Terraria,  so for crafting this item you need 15 bombs      		
            recipe.AddIngredient(null, "Watermelon", 25);
            recipe.AddIngredient(null, "Afro", 1); //this is an example of how to add a modded item as an ingredient
            ...
            recipe.SetResult(this, 1);   //this defines the resultat of hte crafting, so 15 dynamite + 1 customtileitem = 15 Custom Explosive
            recipe.AddRecipe();
        }
    }
}
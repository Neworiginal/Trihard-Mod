...
{
    public class TrinamiteProjectile : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("TrinamiteProjectile");
        }
        public override void SetDefaults()
        {
            projectile.width = 20;   //This defines the hitbox width
            projectile.height = 64;    //This defines the hitbox height
        ...
        public override void Kill(int timeLeft)
        {
            ...
            int radius = 75;     //this is the explosion radius, the highter is the value the bigger is the explosion

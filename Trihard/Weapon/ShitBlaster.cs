...
{
    public class ShitBlaster : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Shit Shotty");
            Tooltip.SetDefault("kill yourself");
        }
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(ModLoader.GetMod("CalamityMod").ItemType("BarOfLife"), 100);
